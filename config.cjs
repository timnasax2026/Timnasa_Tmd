...
const config = {
  ...
  BOT_NAME: process.env.BOT_NAME || "Timnasa-Tmd1",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://files.catbox.moe/q3kghf.jpeg",
  DESCRIPTION: process.env.DESCRIPTION || "Timothy",
  OWNER_NAME: process.env.OWNER_NAME || "Timnasa Timothy",
